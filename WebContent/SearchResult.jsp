...
//사용라이브러리 ->  json-simple-1.1.1.jar
	...
	JSONObject  jsonObject = (JSONObject)jsonParser.parse(data);   // JSONObject {  } 객체로 변환 
	
	JSONArray	jsonArray  = (JSONArray)jsonObject.get("items");  // JSONArray [ ] 배열을 가져옴
...
%>
	...
	<table width="100%" border="1">
		<tr height="40" style="background-color:aqua;">
			<td align="center" width="13%">제목</td>
			<td align="center" width="60%">요약내용</td>
			<td align="center" width="10%">블로거명</td>
			<td align="center" width="10%">작성날짜</td>
			<td align="center" width="7%">링크</td>		
		</tr>
<% 
	for(int i=0;  i<jsonArray.size();  i++){          // JSONArray [ ] 배열안에 
		
	     JSONObject object  = (JSONObject)jsonArray.get(i);    // 객체 { }를 반복해서 보여줌 (index번호 순차적으로)
/*	     
	      {
