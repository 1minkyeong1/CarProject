...
<%-- request내장객체에 저장된 Vector의 정보가 비어있으면?(CarConfirmVo객체들이 없으면) --%>		
...
<c:forEach var="vo" items="${requestScope.v }">
		...
		<tr align="center">
				...
				<td align="center" width="100">
					<a href="${contextPath}/Car/delete.do?orderid=${vo.orderid}&memberphone=${requestScope.memberphone}&center=Delete.jsp">예약취소</a>
				</td>
			</tr>
